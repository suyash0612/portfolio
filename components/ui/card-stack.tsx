    ...
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-[hsl(var(--card))] text-sm text-[hsl(var(--muted-foreground))]">
            No image
          </div>
        )}
      </div>
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        {item.tag && (
          <span className="mb-2 inline-block w-fit rounded-full bg-white/20 px-2.5 py-0.5 text-xs font-medium text-white backdrop-blur-sm">
            {item.tag}
          </span>
        )}
